/* these is an object of the list of coin where
name = {
    "id" : "name"
} 
this is because for coingecko API, we need to use the name to find the prices
and not the ticker (which is the ID). 
hence, we have to do get(......"bitcoin") instead of btc to get the price.
As such, created this function so that we can do name.btc and we'll get "bitcoin" */
...
let coin: any = [
    ...
    {
        "id": "nameuper-ecosystem-network",
        "symbol": "cen",
        "name": "nameuper Ecosystem Network"
    },
    {
        "id": "namewap-space",
        "symbol": "css",
